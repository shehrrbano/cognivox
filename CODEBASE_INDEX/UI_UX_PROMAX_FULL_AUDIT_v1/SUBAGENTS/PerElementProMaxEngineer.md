---
title: Per-Element ProMax Engineer
version: v1
...
# Per-Element ProMax Engineer

## Responsibility
For every element, apply every single point of the UI/UX ProMax skill.

## Engineering Log
| Element | Applied Points | Status |
|---------|----------------|--------|
| TBD | TBD | 🔴 PENDING |
