---
title: ComponentSizeAdjuster Report
version: v1
...
# ComponentSizeAdjuster Report

## Mission
Adjust sidebar width, header heights, graph canvas, transcription box, button sizes, search bar, and all containers to 67% of current dimensions while preserving flex/grid justification and mobile-first collapse.
