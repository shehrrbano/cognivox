...
{:else if name === "live"}
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" class={className}>
...
{:else if name === "clipboard"}
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" class={className}>
        ...
        <rect x="8" y="2" width="5" height="3" rx="1" ry="1"/>
    </svg>
...
{:else if name === "keyboard"}
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" class={className}>
        <rect x="2" y="4" width="13" height="11" rx="2" ry="2"/>
        <path d="M6 8h.001"/>
        <path d="M10 8h.001"/>
        <path d="M14 8h.001"/>
        <path d="M18 8h.001"/>
