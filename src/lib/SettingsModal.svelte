<script lang="ts">
    ...
    async function testConnection() {
        ...
        try {
            ...
            const errorCode = errorStr.includes("429")
                ? 429
    ...
    onMount(() => {
        if (isOpen) {
            ...
            loadApiKeys();
            selectedModel =
                localStorage.getItem("gemini_model") || selectedModel;
            confidenceThreshold = parseFloat(
                localStorage.getItem("confidence_threshold") || "0.7",
            );
            vadSensitivity = parseFloat(
                localStorage.getItem("vad_sensitivity") || "0.5",
            );
        ...
        >
            ...
            <div class="p-6 space-y-8">
                ...
                <section>
                    ...
                    {#if apiKeys.length > 0}
                        <div class="space-y-2 mb-4">
                            {#each apiKeys as apiKey, i}
                                <div
                                    class="flex items-center gap-3 p-3 rounded-lg bg-dark-700/50 border
                                    {apiKey.isActive
                    ...
                    <!-- Add New Key -->
                    <div
                        class="p-4 rounded-lg bg-dark-700/30 border border-cyan-500/10"
                    >
                    ...
                    <div class="mt-4 space-y-3">
                        ...
                        {#if apiKeys.length > 1}
                            <div
                                class="flex items-center justify-between p-3 rounded-lg bg-dark-700/30 border border-cyan-500/10"
                            >
                                <div>
                ...
                <section>
                    ...
                    <!-- Permission Status -->
                    <div
                        class="flex items-center justify-between mb-4 p-3 rounded-lg bg-dark-700/50 border border-cyan-500/10"
                    >
                        <span class="text-sm text-slate-300"
                    ...
                    <div class="mb-4">
                        ...
                        {#if isLoadingDevices}
                            <div class="input-field text-slate-500">
                                Loading devices...
                            </div>
                        {:else}
                            <select
                    ...
                    <!-- Capture Mode -->
                    <div class="mb-4">
                        <div class="block text-xs text-slate-400 mb-2">
                            Capture Source
                        </div>
                    ...
                    >
                        ...
                        {#if isTesting}
                            <div class="space-y-2">
                                <div
                                    class="h-4 bg-dark-600 rounded-full overflow-hidden"
                                >
                                    <div
                                        class="h-full transition-all duration-75 {testVolume >
                                        0.15
                                            ? 'bg-red-500'
                                            : testVolume > 0.05
                                              ? 'bg-green-500'
                        ...
                        {:else}
                            <p class="text-xs text-slate-500">
                                Click to test your microphone before recording.
                            </p>
                        {/if}
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="mb-4">
                        <label
                            ...
                            class="block text-xs text-slate-400 mb-2"
                        >
                            Confidence Threshold: <span class="text-cyan-400"
                ...
                <section>
                    ...
                    <div class="mb-4">
                        <label
                            ...
                            class="block text-xs text-slate-400 mb-2"
                        >
                            Min Speech Buffer: <span class="text-cyan-400"
                                >{vadMinSpeech}s</span
                            >
                        </label>
                        <input
                    ...
                    <div class="mb-4">
                        <label
                            ...
                            class="block text-xs text-slate-400 mb-2"
                        >
                            Silence Detection: <span class="text-cyan-400"
                    ...
                    <div class="mb-4">
                        <label
                            ...
                            class="block text-xs text-slate-400 mb-2"
                        >
                            Min Chunk Size: <span class="text-cyan-400"
                                >{vadMinChunk}s</span
                            >
                        </label>
                        <input
