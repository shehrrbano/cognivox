...
// We use a relative glob path ('../assets/svg/**/*.svg') instead of the aliased path ('@/assets/svg/**/*.svg').
// This prevents Vite's import.meta.glob from failing on Windows where absolute path resolution 
// can sometimes climb out of the project root incorrectly.
