...
def init_llm_factory():
    ...
    # Document: Ensure the factory LLM list is at least an empty list to avoid iteration errors
    # during first-time database initialization before system settings are fully loaded.
    factory_llm_infos = settings.FACTORY_LLM_INFOS or []
